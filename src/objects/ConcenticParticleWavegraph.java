...
public class ConcenticParticleWavegraph extends DisplayableObject {
	 ...
	 */
	public ConcenticParticleWavegraph(PApplet parent, PVector location, float radiusSpacing, int binlength,
	...
	/**
	 * Calculates xz coords for particles based on spacing, binLength and
	 * particles per layer
	 */
