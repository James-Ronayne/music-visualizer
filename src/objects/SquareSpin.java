...
/**
 * Draws squares on wall that are generated in time with music.
 * The squares rotate, shrink and fade until they are destroyed after there life span
...
public class SquareSpin extends DisplayableObject {
	...
	/**
	 * Draws all squares contained in squares arraylist and adds new square if requested
	 */
