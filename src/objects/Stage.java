...
/**
 * Creates Stage with four walls and ceiling textured
 * and RGB square floor made of different coloured tiles
 * that change colour in time with audio
...
//        p = parent.createShape(PConstants.RECT,-width/2,-width/2,width,width);
//        p = parent.createShape(PConstants.QUAD,-width/2,-width/2,-width/2,width/2,width/2,width/2,width/2,-width/2);
        p = parent.createShape(PConstants.QUAD,width/2,-width/2,width/2,width/2,-width/2,width/2,-width/2,-width/2);
